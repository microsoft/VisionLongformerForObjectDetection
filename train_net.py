...
from msvit import add_vit_config, FixSizeDatasetMapper
from detectron2.checkpoint import DetectionCheckpointer
from detectron2.config import get_cfg
from detectron2.data import build_detection_train_loader, build_detection_test_loader
from detectron2.engine import AMPTrainer, SimpleTrainer, DefaultTrainer, default_argument_parser, default_setup, launch
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        if cfg.INPUT.FIX_SIZE:
            mapper = FixSizeDatasetMapper(cfg, True)
        else:
            mapper = None
        ...
        for key, value in model.named_parameters(recurse=True):
            ...
            for layer_key in cfg.SOLVER.LR_MULTIPLIERS:
                if layer_key in key:
                    ...
                    lr = cfg.SOLVER.BASE_LR * layer_lr_mult
